...
//
// No product photos are included yet: the screenshots show WhatsApp's own
// thumbnails, which aren't URLs I can host from. Send the actual photo
// files and I'll add them to `image` below.
//
...
export const catalogItems: CatalogItem[] = [
  ...
  // per-m² pricing) — possibly a second listing in the source catalog.
  {
